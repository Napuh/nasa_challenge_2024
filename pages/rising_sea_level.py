...
st.set_page_config(page_title="Rising Sea Level", initial_sidebar_state="collapsed")
apply_css_fixes()
load_dotenv()
...
st.session_state["collection_to_ask"] = "rising_sea_level"
