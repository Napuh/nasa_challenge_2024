...
st.set_page_config(page_title="Tropical Rainstorms", initial_sidebar_state="collapsed")
apply_css_fixes()
load_dotenv()
...
st.session_state["collection_to_ask"] = "tropical_rainstorms"
